...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_voyager(
    ...
    KC_NO,          KC_Q,           KC_X,           LT(3,KC_M),     MT(MOD_LCTL, KC_C),KC_V,                                           KC_K,           MT(MOD_LCTL, KC_P),LT(2,KC_DOT),   KC_MINUS,       KC_SLASH,       MO(5),          
  ...
  [1] = LAYOUT_voyager(
    ...
    KC_BSLS,        KC_ASTR,        KC_LCBR,        KC_RCBR,        KC_DQUO,        KC_UNDS,                                        KC_RABK,        TD(DANCE_2),    KC_DLR,         KC_EXLM,        KC_AT,          KC_NO,          
    KC_NO,          KC_PERC,        KC_LBRC,        KC_RBRC,        KC_COLN,        KC_GRAVE,                                       KC_LABK,        KC_QUES,        KC_CIRC,        KC_AMPR,        KC_TILD,        KC_NO,          
  ...
  [2] = LAYOUT_voyager(
    ...
    KC_NO,          KC_SLASH,       KC_6,           KC_5,           KC_4,           KC_COMMA,                                       KC_NO,          KC_NO,          KC_TRANSPARENT, KC_LEFT_SHIFT,  KC_NO,          KC_NO,          
