...
const uint16_t PROGMEM combo5[] = { MT(MOD_LALT, KC_R), MT(MOD_LGUI, KC_T), LT(3,KC_S), COMBO_END};
const uint16_t PROGMEM combo6[] = { LT(2,KC_H), MT(MOD_LGUI, KC_A), MT(MOD_LALT, KC_E), COMBO_END};
