...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_voyager(
    ...
    KC_TAB,         KC_B,           KC_L,           KC_D,           KC_W,           KC_Z,                                           KC_QUOTE,       KC_F,           LT(2,KC_O),     KC_U,           KC_J,           KC_SCLN,        
    ...
    KC_NO,          KC_Q,           KC_X,           LT(3,KC_M),     MT(MOD_LCTL, KC_C),KC_V,                                           KC_K,           MT(MOD_LCTL, KC_P),KC_DOT,         KC_MINUS,       KC_SLASH,       MO(5),          
                                                    MT(MOD_LSFT, KC_BSPC),LT(6,KC_ENTER),                                 LT(4,KC_ESCAPE),LT(1,KC_SPACE)
  ),
  [1] = LAYOUT_voyager(
    KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,                                          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          
    KC_PIPE,        KC_HASH,        KC_LPRN,        KC_RPRN,        KC_EQUAL,       KC_NO,                                          KC_NO,          KC_AMPR,        TD(DANCE_2),    KC_NO,          KC_NO,          KC_NO,          
    KC_BSLS,        KC_ASTR,        KC_LCBR,        KC_RCBR,        KC_DQUO,        KC_UNDS,                                        KC_DLR,         KC_PLUS,        KC_RABK,        KC_EXLM,        KC_AT,          KC_TILD,        
    KC_NO,          KC_PERC,        KC_LBRC,        KC_RBRC,        KC_COLN,        KC_GRAVE,                                       KC_CIRC,        KC_QUES,        KC_NO,          KC_NO,          KC_NO,          KC_NO,          
                                                    KC_BSPC,        KC_SPACE,                                       KC_NO,          KC_TRANSPARENT
  ),
  [2] = LAYOUT_voyager(
    KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,                                          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          
    KC_NO,          KC_NO,          KC_9,           KC_8,           KC_7,           KC_NO,                                          KC_NO,          KC_EQUAL,       KC_TRANSPARENT, LALT(KC_LEFT_SHIFT),KC_NO,          KC_NO,          
    KC_NO,          KC_MINUS,       KC_3,           KC_2,           KC_1,           KC_DOT,                                         KC_LEFT_ALT,    TD(DANCE_3),    KC_NO,          KC_NO,          KC_NO,          KC_NO,          
    KC_NO,          KC_SLASH,       KC_6,           KC_5,           KC_4,           KC_COMMA,                                       KC_NO,          KC_ASTR,        KC_NO,          KC_NO,          KC_NO,          KC_NO,          
                                                    MT(MOD_LCTL, KC_0),KC_BSPC,                                        KC_UNDS,        KC_PERC
  ),
  [3] = LAYOUT_voyager(
    KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,                                          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          
    KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,                                          ST_MACRO_0,     LGUI(KC_LEFT),  KC_UP,          LGUI(KC_RIGHT), KC_NO,          KC_NO,          
    KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_TRANSPARENT, KC_NO,                                          LALT(KC_LEFT),  KC_LEFT,        KC_DOWN,        KC_RIGHT,       LALT(KC_RIGHT), KC_NO,          
