...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [2] = LAYOUT_voyager(
    KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,                                          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          
    KC_NO,          KC_BSLS,        KC_LABK,        KC_RABK,        KC_CIRC,        KC_TILD,                                        KC_UNDS,        KC_RPRN,        KC_AT,          KC_RCBR,        KC_PIPE,        KC_NO,          
    KC_NO,          KC_LBRC,        KC_LCBR,        KC_EXLM,        KC_LPRN,        KC_PLUS,                                        KC_MINUS,       KC_COLN,        KC_DQUO,        KC_EQUAL,       KC_RBRC,        KC_NO,          
    KC_NO,          KC_HASH,        KC_PERC,        KC_GRAVE,       KC_DLR,         KC_ASTR,                                        KC_SLASH,       KC_QUES,        KC_DOT,         KC_COMMA,       KC_AMPR,        KC_NO,          
