...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_voyager(
    ...
    MAGIC,         LT(3, KC_N),    MT(MOD_LALT, KC_R),MT(MOD_LSFT, KC_T),MT(MOD_LGUI, KC_S),MEH_T(KC_G),                                    MEH_T(KC_Y),    MT(MOD_LGUI, KC_H),MT(MOD_LSFT, KC_A),MT(MOD_LALT, KC_E),LT(5, KC_I),    KC_COMMA,       
