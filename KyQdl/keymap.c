...
const uint16_t PROGMEM combo3[] = { MT(MOD_LALT, KC_R), MT(MOD_LGUI, KC_T), COMBO_END};
...
const uint16_t PROGMEM combo7[] = { MT(MOD_LALT, KC_R), MT(MOD_LGUI, KC_T), MT(MOD_LSFT, KC_S), COMBO_END};
