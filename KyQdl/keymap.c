...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_voyager(
    ...
    KC_DELETE,      KC_N,           MT(MOD_LALT, KC_R),MT(MOD_LGUI, KC_T),LT(3,KC_S),     ALL_T(KC_G),                                    ALL_T(KC_Y),    LT(2,KC_H),     MT(MOD_LGUI, KC_A),MT(MOD_LALT, KC_E),KC_I,           KC_NO,          
    LSFT(KC_ENTER), KC_Q,           KC_X,           KC_M,           MT(MOD_LCTL, KC_C),KC_V,                                           KC_K,           MT(MOD_LCTL, KC_P),KC_DOT,         KC_COMMA,       KC_SLASH,       MO(5),          
                                                    MT(MOD_LSFT, KC_BSPC),LT(6,KC_F23),                                   LT(4,KC_F24),   LT(1,KC_SPACE)
  ),
  [1] = LAYOUT_voyager(
...
const uint16_t PROGMEM combo4[] = { LT(2,KC_H), MT(MOD_LGUI, KC_A), MT(MOD_LALT, KC_E), COMBO_END};
...
const uint16_t PROGMEM combo8[] = { MT(MOD_LGUI, KC_A), MT(MOD_LALT, KC_E), COMBO_END};
