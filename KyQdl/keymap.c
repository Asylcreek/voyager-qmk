...
void dance_0_finished(tap_dance_state_t *state, void *user_data) {
  ...
  case SINGLE_TAP:
    ...
    break;
  case DOUBLE_TAP:
    register_code16(LALT(LCTL(LSFT(KC_W))));
    break;
...
void dance_0_reset(tap_dance_state_t *state, void *user_data) {
  ...
  case SINGLE_TAP:
    ...
    break;
  case DOUBLE_TAP:
    unregister_code16(LALT(LCTL(LSFT(KC_W))));
    break;
  case DOUBLE_SINGLE_TAP:
    unregister_code16(KC_W);
    break;
...
void dance_1_finished(tap_dance_state_t *state, void *user_data) {
  ...
  case SINGLE_TAP:
    ...
    break;
  case DOUBLE_TAP:
    register_code16(LALT(LCTL(LSFT(KC_Z))));
    break;
  case DOUBLE_SINGLE_TAP:
    tap_code16(KC_Z);
    register_code16(KC_Z);
...
void dance_1_reset(tap_dance_state_t *state, void *user_data) {
  ...
  case SINGLE_TAP:
    ...
    break;
  case DOUBLE_TAP:
    unregister_code16(LALT(LCTL(LSFT(KC_Z))));
    break;
  case DOUBLE_SINGLE_TAP:
    unregister_code16(KC_Z);
    break;
...
void dance_2_finished(tap_dance_state_t *state, void *user_data) {
  ...
  case SINGLE_TAP:
    ...
    break;
  case DOUBLE_TAP:
    register_code16(LALT(LCTL(LSFT(KC_R))));
    break;
  case DOUBLE_SINGLE_TAP:
    tap_code16(KC_R);
    register_code16(KC_R);
...
void dance_2_reset(tap_dance_state_t *state, void *user_data) {
  ...
  case SINGLE_TAP:
    ...
    break;
  case DOUBLE_TAP:
    unregister_code16(LALT(LCTL(LSFT(KC_R))));
    break;
  case DOUBLE_SINGLE_TAP:
    unregister_code16(KC_R);
    break;
...
void dance_5_finished(tap_dance_state_t *state, void *user_data) {
  ...
  case SINGLE_TAP:
    ...
    break;
  case DOUBLE_TAP:
    register_code16(LALT(LCTL(LSFT(KC_G))));
    break;
  case DOUBLE_SINGLE_TAP:
    tap_code16(KC_G);
    register_code16(KC_G);
...
void dance_5_reset(tap_dance_state_t *state, void *user_data) {
  ...
  case SINGLE_TAP:
    ...
    break;
  case DOUBLE_TAP:
    unregister_code16(LALT(LCTL(LSFT(KC_G))));
    break;
  case DOUBLE_SINGLE_TAP:
    unregister_code16(KC_G);
    break;
...
void dance_7_finished(tap_dance_state_t *state, void *user_data) {
  ...
  case SINGLE_TAP:
    ...
    break;
  case DOUBLE_TAP:
    register_code16(LALT(LCTL(LSFT(KC_F))));
    break;
  case DOUBLE_SINGLE_TAP:
    tap_code16(KC_F);
    register_code16(KC_F);
...
void dance_7_reset(tap_dance_state_t *state, void *user_data) {
  ...
  case SINGLE_TAP:
    ...
    break;
  case DOUBLE_TAP:
    unregister_code16(LALT(LCTL(LSFT(KC_F))));
    break;
  case DOUBLE_SINGLE_TAP:
    unregister_code16(KC_F);
    break;
...
void dance_10_finished(tap_dance_state_t *state, void *user_data) {
  ...
  case SINGLE_TAP:
    ...
    break;
  case DOUBLE_TAP:
    register_code16(LALT(LCTL(LSFT(KC_E))));
    break;
  case DOUBLE_SINGLE_TAP:
    tap_code16(KC_E);
    register_code16(KC_E);
...
void dance_10_reset(tap_dance_state_t *state, void *user_data) {
  ...
  case SINGLE_TAP:
    ...
    break;
  case DOUBLE_TAP:
    unregister_code16(LALT(LCTL(LSFT(KC_E))));
    break;
  case DOUBLE_SINGLE_TAP:
    unregister_code16(KC_E);
    break;
...
void dance_11_finished(tap_dance_state_t *state, void *user_data) {
  ...
  case SINGLE_TAP:
    ...
    break;
  case DOUBLE_TAP:
    register_code16(LALT(LCTL(LSFT(KC_I))));
    break;
  case DOUBLE_SINGLE_TAP:
    tap_code16(KC_I);
    register_code16(KC_I);
...
void dance_11_reset(tap_dance_state_t *state, void *user_data) {
  ...
  case SINGLE_TAP:
    ...
    break;
  case DOUBLE_TAP:
    unregister_code16(LALT(LCTL(LSFT(KC_I))));
    break;
  case DOUBLE_SINGLE_TAP:
    unregister_code16(KC_I);
    break;
...
void dance_12_finished(tap_dance_state_t *state, void *user_data) {
  ...
  case SINGLE_TAP:
    ...
    break;
  case DOUBLE_TAP:
    register_code16(LALT(LCTL(LSFT(KC_K))));
    break;
  case DOUBLE_SINGLE_TAP:
    tap_code16(KC_K);
    register_code16(KC_K);
...
void dance_12_reset(tap_dance_state_t *state, void *user_data) {
  ...
  case SINGLE_TAP:
    ...
    break;
  case DOUBLE_TAP:
    unregister_code16(LALT(LCTL(LSFT(KC_K))));
    break;
  case DOUBLE_SINGLE_TAP:
    unregister_code16(KC_K);
    break;
...
tap_dance_action_t tap_dance_actions[] = {
    ...
    [DANCE_10] = ACTION_TAP_DANCE_FN_ADVANCED(on_dance_10, dance_10_finished,
                                              dance_10_reset),
    [DANCE_11] = ACTION_TAP_DANCE_FN_ADVANCED(on_dance_11, dance_11_finished,
                                              dance_11_reset),
    [DANCE_12] = ACTION_TAP_DANCE_FN_ADVANCED(on_dance_12, dance_12_finished,
                                              dance_12_reset),
    [DANCE_13] = ACTION_TAP_DANCE_FN_ADVANCED(on_dance_13, dance_13_finished,
                                              dance_13_reset),
};
