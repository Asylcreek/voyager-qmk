...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [3] = LAYOUT_voyager(
    ...
    KC_NO,          KC_NO,          KC_LEFT_ALT,    KC_NO,          KC_LEFT_SHIFT,  KC_NO,                                          KC_NO,          KC_PAGE_UP,     KC_PGDN,        KC_NO,          KC_NO,          KC_NO,          
                                                    MT(MOD_LGUI, KC_F23),KC_F20,                                         KC_F22,         KC_F21
  ),
  [4] = LAYOUT_voyager(
  ...
  case KC_QUOTE: {
    ...
    if (record->event.pressed) {
      ...
      if (registered_keycode) { // Invoked through Repeat key.
        ...
        registered_keycode = shifted ? KC_QUOTE : KC_UNDS;
      }
