...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [3] = LAYOUT_voyager(
    KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,                                          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          
    KC_NO,          KC_BSLS,        KC_LABK,        KC_COLN,        KC_CIRC,        KC_TILD,                                        KC_UNDS,        KC_GRAVE,       KC_EQUAL,       KC_RABK,        KC_PERC,        KC_NO,          
    KC_NO,          KC_LBRC,        KC_LCBR,        KC_AT,          KC_LPRN,        KC_PLUS,                                        KC_MINUS,       KC_RPRN,        KC_DQUO,        KC_RCBR,        KC_RBRC,        KC_NO,          
    KC_NO,          KC_HASH,        KC_PIPE,        KC_EXLM,        KC_DLR,         KC_ASTR,                                        KC_SLASH,       KC_QUES,        KC_DOT,         KC_COMMA,       KC_AMPR,        KC_NO,          
                                                    KC_TRANSPARENT, KC_NO,                                          KC_F24,         LT(4, KC_F23)
  ),
  [4] = LAYOUT_voyager(
    KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,                                          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          
  ...
  [5] = LAYOUT_voyager(
    ...
    KC_NO,          LALT(LGUI(LCTL(LSFT(KC_C)))),KC_NO,          TOGGLE_SCROLL,  LALT(LGUI(LCTL(LSFT(KC_S)))),LSFT(KC_MS_BTN1),                                KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          
...
const uint16_t PROGMEM combo0[] = { MT(MOD_LSFT, KC_S), MT(MOD_LSFT, KC_H), COMBO_END};
