...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_voyager(
    ...
    KC_NO,          KC_B,           KC_L,           MEH_T(KC_D),    KC_W,           KC_Z,                                           KC_QUOTE,       KC_F,           MEH_T(KC_O),    KC_U,           KC_J,           KC_DELETE,      
  ...
  [2] = LAYOUT_voyager(
    ...
    KC_NO,          KC_NO,          KC_TAB,         KC_ESCAPE,      KC_ENTER,       QK_LLCK,                                        KC_PERC,        KC_4,           KC_5,           KC_6,           KC_SLASH,       KC_NO,          
