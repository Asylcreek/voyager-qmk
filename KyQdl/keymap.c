...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_voyager(
    ...
    KC_NO,          MT(MOD_LSFT, KC_N),MT(MOD_LALT, KC_R),MT(MOD_LGUI, KC_T),LT(3,KC_S),     ALL_T(KC_G),                                    ALL_T(KC_Y),    LT(2,KC_H),     MT(MOD_LGUI, KC_A),MT(MOD_LALT, KC_E),MT(MOD_LSFT, KC_I),LSFT(KC_ENTER), 
    KC_NO,          KC_Q,           KC_X,           KC_M,           MT(MOD_LCTL, KC_C),KC_V,                                           KC_K,           MT(MOD_LCTL, KC_P),KC_DOT,         KC_COMMA,       KC_SLASH,       MO(5),          
                                                    KC_F23,         LT(6,KC_BSPC),                                  LT(4,KC_F24),   LT(1,KC_SPACE)
  ),
  [1] = LAYOUT_voyager(
    KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,                                          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          
    KC_PIPE,        KC_BSLS,        KC_LPRN,        KC_RPRN,        KC_EQUAL,       KC_NO,                                          KC_NO,          KC_TILD,        KC_AMPR,        KC_PLUS,        KC_HASH,        KC_NO,          
    KC_NO,          KC_EXLM,        KC_LCBR,        KC_RCBR,        KC_DQUO,        KC_DLR,                                         KC_UNDS,        TD(DANCE_2),    KC_LABK,        KC_ASTR,        KC_CIRC,        KC_NO,          
  ...
  [2] = LAYOUT_voyager(
    KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,                                          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          
    KC_NO,          KC_ASTR,        KC_9,           KC_8,           KC_7,           KC_NO,                                          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          
    KC_NO,          KC_MINUS,       KC_3,           KC_2,           KC_1,           KC_NO,                                          KC_NO,          KC_TRANSPARENT, KC_0,           KC_DOT,         KC_COMMA,       KC_NO,          
    KC_NO,          KC_PLUS,        KC_6,           KC_5,           KC_4,           KC_NO,                                          KC_NO,          KC_NO,          KC_PERC,        KC_EQUAL,       KC_SLASH,       KC_NO,          
                                                    KC_TRANSPARENT, KC_BSPC,                                        KC_UNDS,        KC_LEFT_CTRL
  ),
  [3] = LAYOUT_voyager(
    KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,                                          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          
    KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,                                          ST_MACRO_0,     LGUI(KC_LEFT),  KC_UP,          LGUI(KC_RIGHT), KC_NO,          KC_NO,          
    KC_NO,          KC_NO,          KC_LEFT_ALT,    KC_LEFT_GUI,    KC_TRANSPARENT, KC_NO,                                          LALT(KC_LEFT),  KC_LEFT,        KC_DOWN,        KC_RIGHT,       LALT(KC_RIGHT), KC_NO,          
    KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,                                          KC_NO,          KC_PAGE_UP,     KC_PGDN,        KC_NO,          KC_NO,          KC_NO,          
...
const uint16_t PROGMEM combo0[] = { LT(3,KC_S), MT(MOD_LGUI, KC_T), COMBO_END};
const uint16_t PROGMEM combo1[] = { LT(2,KC_H), MT(MOD_LGUI, KC_A), COMBO_END};
const uint16_t PROGMEM combo2[] = { MT(MOD_LCTL, KC_C), KC_M, COMBO_END};
const uint16_t PROGMEM combo3[] = { MT(MOD_LALT, KC_R), MT(MOD_LGUI, KC_T), LT(3,KC_S), COMBO_END};
const uint16_t PROGMEM combo4[] = { KC_O, KC_U, COMBO_END};
const uint16_t PROGMEM combo5[] = { KC_M, KC_X, COMBO_END};
const uint16_t PROGMEM combo6[] = { KC_X, KC_M, MT(MOD_LCTL, KC_C), COMBO_END};
const uint16_t PROGMEM combo7[] = { MT(MOD_LALT, KC_R), MT(MOD_LGUI, KC_T), COMBO_END};
const uint16_t PROGMEM combo8[] = { KC_D, KC_L, COMBO_END};
const uint16_t PROGMEM combo9[] = { KC_DOT, KC_COMMA, COMBO_END};
const uint16_t PROGMEM combo10[] = { MT(MOD_LALT, KC_E), MT(MOD_LGUI, KC_A), COMBO_END};
